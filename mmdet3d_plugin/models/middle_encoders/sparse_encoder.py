...
# Adapted to include init-cfg for loading pretrained weights
import warnings
...
class SparseEncoderCustom(BaseModule):
    ...
    def __init__(self,
        ...
        super(SparseEncoderCustom, self).__init__(init_cfg=init_cfg)
