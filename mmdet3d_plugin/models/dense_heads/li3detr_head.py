...
class Li3DeTrHead(BaseDenseHead):
    """
    This is the head for Li3DeTr model
    """
    ...
    def forward_train(self,
        ...
        outs = self(point_feats, img_metas)
    ...
    def forward(self, point_feats, img_metas):
        ...
        # with Encoder
        hs, init_reference, inter_reference = self.transformer(point_feats,
                                                               mlvl_masks_point,
                                                               mlvl_pos_enc_point,
                                                               query,
