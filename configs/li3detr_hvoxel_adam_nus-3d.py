...
model = dict(
    ...
    pts_middle_encoder=dict(
        ...
        init_cfg=dict(type='Pretrained',
                      checkpoint='ckpts/voxel_objdgcnn.pth',
...
log_level = 'INFO'
work_dir = None
# load_from = 'project/ckpts/fcos3d.pth'
# load_from = 'project/ckpts/pillar.pth'
# load_from = '/mnt/hdd4/achieve-itn/PhD/Code/workdirs/MSFDETR3DV5_2_voxel-nus_trial2/epoch_12.pth'
load_from = None
resume_from = None
workflow = [('train', 1)]
